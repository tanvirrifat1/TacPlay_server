...
const createPlayerFromDb = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    const value = {
      ...req.body,
    };

    await UserService.createPlayerFromDb(value);
...
const createFiledOwnerFromDb = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    const value = {
      ...req.body,
    };

    await UserService.createFiledOwnerFromDb(value);
